      ...
      <div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
        ...
        <form>
          ...
          <div>
            ...
            <input type="text" placeholder='Prisha Jain' className='w-full input input-bordered h-10'></input>
          </div>
          ...
          <div>
            ...
            <input type="text" placeholder='prishajain' className='w-full input input-bordered h-10'/>
          </div>
